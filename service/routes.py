...
# The below test case should be moved to your test files
...
def list_products_by_name():
    """Returns a list of Products filtered by name"""
...
def list_products_by_availability():
    """Returns a list of Products filtered by availability"""
    ...
    if available and available.lower() == 'true':
        app.logger.info("Find by availability: true")
        products = [product for product in Product.all() if product.available is True]
    else:
        app.logger.info("Find all")
        products = Product.all()
